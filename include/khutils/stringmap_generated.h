...
namespace khutils
{
	namespace hashstring_map
	{
		...
		{
			return khutils::hashstring_map::CreateMapEntry(_fbb, id, value ? _fbb.CreateString(value) : 0);
		}
		...
		{
			return khutils::hashstring_map::CreateMap(_fbb, entries ? _fbb.CreateVector<flatbuffers::Offset<MapEntry>>(*entries) : 0);
		}
															...
															const flatbuffers::rehasher_function_t* _rehasher)
		{
			...
			return khutils::hashstring_map::CreateMapEntry(_fbb, _id, _value);
		}
												  ...
												  const flatbuffers::rehasher_function_t* _rehasher)
		{
			...
			auto _entries
			  = _o->entries.size() ?
				  ...
				  0;
			return khutils::hashstring_map::CreateMap(_fbb, _entries);
		}
