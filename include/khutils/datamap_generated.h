...
namespace khutils
{
	namespace data_map
	{
		...
		{
			return CreateMapEntry(_fbb, id ? _fbb.CreateString(id) : 0, data ? _fbb.CreateVector<uint8_t>(*data) : 0);
		}
		...
		{
			(void)rehasher;
			return CreateMapEntry(_fbb, _fbb.CreateString(_o->id), _o->data.size() ? _fbb.CreateVector(_o->data) : 0);
		}
